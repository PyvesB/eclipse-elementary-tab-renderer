...
package io.github.pyvesb.elementary_tab_renderer;
...
public class ElementaryCTabFolderRenderer extends CTabFolderRenderer implements ICTabRendering {
	...
	@Inject
	public ElementaryCTabFolderRenderer(CTabFolder parent) {
		super(parent);
	}
